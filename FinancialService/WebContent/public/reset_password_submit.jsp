  ...
  <div data-role="page">
	...
	<table width="100%">
		<tr>
			...
			<td align="center" width="34%"><a style="color:white;">密码重置成功</a></td>
			<td width="33%">&nbsp;&nbsp;</td>
		</tr>
	</table>
  	...
  	<div data-role="content">
		...
		<%
			...
			//String registerZhiCheng = request.getParameter("registerZhiCheng");
				...
				user_dao.reset_user_password(registerTel, registerPW);
				
					%>
					
					<center>
					<br>
					<p style='color:red;'>恭喜您 <strong><%=registerTel %> </strong> ，您已成功重置密码！
					<br>
					<br>正在“会员中心”，请稍后...</p>
					<br>
